...
urlpatterns = [
    ...
    path('add_food/', views.add_food, name="food add"),
    path('edit/<slug:food_slug>/', views.edit_food, name="food edit"),
    path('delete/<slug:food_slug>/', views.delete_food, name="food delete"),
]